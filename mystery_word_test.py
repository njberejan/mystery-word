...
class TestMysteryWord(unittest.TestCase):
    ...
    def test_easy_words(self):
        self.assertEqual(create_list(potential_words_easy), ["bird", "calf", "river", "stream", "brain"])


    def test_medium_words(self):
        self.assertEqual(create_list(potential_words_medium), ["stream", "kneecap", "cookbook", "language", "sneaker"])


    def test_hard_words(self):
        self.assertEqual(create_list(potential_words_hard), ["cookbook", "language", "algorithm", "integration"])
